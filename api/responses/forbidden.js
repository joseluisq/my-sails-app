...
module.exports = function forbidden(data, options) {
    ...
    if (data !== undefined) {
        sails.log.verbose('Sending ' + HTTPStatus.FORBIDDEN.code.toString() + ' ("Forbidden") response: \n', data);
    }
    else
        sails.log.verbose('Sending ' + HTTPStatus.FORBIDDEN.code.toString() + ' ("Forbidden") response');
    ...
    if (req.wantsJSON) {
        return res.jsonx({code: HTTPStatus.FORBIDDEN.code, data: data});
    }
    ...
    // but fall back to sending JSON(P) if any errors occur.
        ...
        return res.view(HTTPStatus.FORBIDDEN.code.toString(), {data: data}, function (err, html) {
